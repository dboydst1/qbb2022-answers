...
10. Part 6 question: Do you expect each region in H1 or H2 to correspond to the same parent of origin (i.e. the same haplotype)? Explain your reasoning. --> good job using the biology provided in the reference to answer this; Additionally, the software are processing all of these regions separately, and aren't sharing information about the regions.
